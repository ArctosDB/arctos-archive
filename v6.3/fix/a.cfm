...
<head>
	...
	<cfoutput>
		...
		<cfset session.header_image="/images/ArctosBlue-generic-headers.png">
		
		<cfset session.collection_link_text="I don't know what to say here">
		
		<cfset session.institution_link_text='Collaborative Collection Management System'>
			...
			<table width="95%" cellpadding="0" cellspacing="0" border="0" id="headerContent">
				<tr>
					<td width="95" nowrap="nowrap" class="headerImageCell" id="headerImageCell">
						<a target="_top" href="#session.collection_url#"><img class="headerImage" src="#session.header_image#" alt="Arctos" border="0"></a>
					</td>
...
<hr>
	...
	<cfoutput>
		...
		<cfset session.header_image="/images/reverse-Arctos-generic-headers.png">
		
		
		
		
		<cfset session.collection_link_text ="Collaborative Collection Management System">
		
		<cfset session.institution_link_text ='Dead Rats n Stuff'>
...
<hr>
	...
	<cfoutput>
		...
		<cfset session.institution_link_text =''>
