		...
		<cfloop query="x">
			...
			<tr>
				...
				<cfquery name="a" datasource="uam_god">
					...
					from 
						cumvmamm.accessionagents accessionagents,
						cumvmamm.AgentAddress AgentAddress,
						cumvmamm.Agent Agent
					where
				...
				<cfloop from="1" to="7" index="x"><!--- make sure this number stays OK --->
					...
					<cfset "agnt#x#"=a.merged_name[x]>
					<cfset "agntr#x#"=a.role[x]>
				...
				insert into cumvmamm_accn_temp (
					ACCN_NUMBER,
					ACCN_STATUS,
					ACCN_TYPE,
					nature_of_material,
			...
			<tr>
				...
				<cfquery name="a" datasource="uam_god">
					select 
						...
						AccessionAgents.Remarks
					from 
						cumvfish.accessionagents accessionagents,
						cumvfish.AgentAddress AgentAddress,
						cumvfish.Agent Agent
					where
						accessionagents.AgentAddressID=AgentAddress.AgentAddressID (+) and
						AgentAddress.AgentID=Agent.AgentID (+) and
						accessionagents.accessionID=#accessionID#
				...
				insert into cumvfish_accn_temp (
					ACCN_NUMBER,
					ACCN_STATUS,
					ACCN_TYPE,
					nature_of_material,
			...
			<tr>
				...
				<cfquery name="a" datasource="uam_god">
					select 
						...
						AccessionAgents.Remarks
					from 
						cumvherp.accessionagents accessionagents,
						cumvherp.AgentAddress AgentAddress,
						cumvherp.Agent Agent
					where
						accessionagents.AgentAddressID=AgentAddress.AgentAddressID (+) and
						AgentAddress.AgentID=Agent.AgentID (+) and
						accessionagents.accessionID=#accessionID#
				...
				insert into cumvherp_accn_temp (
					ACCN_NUMBER,
					ACCN_STATUS,
					ACCN_TYPE,
					nature_of_material,
			...
			<tr>
				...
				<cfquery name="a" datasource="uam_god">
					select 
						...
						AccessionAgents.Remarks
					from 
						cumvbird.accessionagents accessionagents,
						cumvbird.AgentAddress AgentAddress,
						cumvbird.Agent Agent
					where
						accessionagents.AgentAddressID=AgentAddress.AgentAddressID (+) and
						AgentAddress.AgentID=Agent.AgentID (+) and
						accessionagents.accessionID=#accessionID#
				...
				insert into cumvbird_accn_temp (
					ACCN_NUMBER,
					ACCN_STATUS,
					ACCN_TYPE,
					nature_of_material,
