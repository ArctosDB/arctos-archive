...
<cffunction name="onApplicationStart" returnType="boolean" output="true">
	...
	<cfquery name="cf_global_settings" datasource="uam_god">
		select BUG_REPORT_EMAIL,DATA_REPORT_EMAIL,LOG_EMAIL,GOOGLE_UACCT from cf_global_settings
	</cfquery>
	...
	<cfcatch>
		...
		<cfmail subject="bad app start" to="#Application.bugReportEmail#" from="badAppStart@#application.fromEmail#" type="html">
