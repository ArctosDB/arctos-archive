...
<cfoutput>
	...
	<cfset numberOfNamesOneFetch="400">
...
<br>beforeloop: #len(theseNames)#----	

		<br>inloop: #len(theseNames)#


				<br>afterloop: #len(theseNames)#----	
	<br>
			...
			----->
	<!--- keep URI under {some unknown number of} chars or globalnames dies. Just arbitrarily remove names to get there - first is easiest. ---->	
...
insert into taxon_term (
	...
	<cfset ticksTaken = GetTickCount() - startTicks />
	
	<hr>runtime: #ticksTaken#
</cfoutput>
